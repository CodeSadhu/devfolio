class ProjectUtils {
  static const List<String> banners = [
    ...
    'assets/projects/Normie.png',
    'assets/projects/Carded.png',
  ];
  ...
  static const List<String> titles = [
    ...
    'Normie - A Dart Utility Package',
    'Carded - A Flutter Package',
  ];
  ...
  static const List<String> links = [
    ...
    'https://pub.dev/packages/normie',
    'https://pub.dev/packages/carded',
  ];
}
